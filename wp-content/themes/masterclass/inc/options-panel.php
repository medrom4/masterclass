    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'text-header',
                'type'     => 'text',
                'title'    => __( 'Подпись в шапке', 'redux-framework-demo' ),
                'subtitle' => __( 'Введите сюда', 'redux-framework-demo' ),
                'desc'     => __( 'Текст в шапке', 'redux-framework-demo' ),
                'default'  => 'ЕСЛИ ВЫ ХОТИТЕ ПОЛУЧИТЬ ХУДОЖЕСТВЕННЫЙ ОРГАЗМ, СМОТРЯ НА КАРТИНЫ - СПУСКАЙТЕСЬ НИЖЕ ...',
            ),   
